...
export const writing: WritingEntry[] = [
  ...
  },
  {
    ...
    date: "2026-08-10",
    excerpt:
      "EP. 01 — the first entry in a series on building Connect, starting with a simple question about why Japan has no nationwide blood-supply network for the 15.6 million dogs and cats who call it home.",
    content: [
      ...
      "That question led me to build Connect.inc — a digital blood-donor platform for companion animals in Japan.",
      "Connect is designed to bring pet owners, eligible blood donors, and veterinary hospitals into one network.",
      "Instead of relying solely on individual hospitals or personal networks to find donors, Connect aims to make donor registration and matching more accessible, while working with veterinary institutions to build a safe and trusted donation ecosystem.",
      "Connecting blood. Connecting owners. Connecting hospitals. Connecting lives.",
      "Connect is starting with blood donation, but the vision goes beyond a single transfusion.",
